...
import {BOOKING_HELP_OPTIONS} from '../../constants/HelpPage/HelpPageConstants';
    ...
    return (
      <View className="help-page-radio-wrapper" style={this.props.style}>
        <RadioButton
          ...
          onClick={() => {
            this.handleRadioClick(BOOKING_HELP_OPTIONS.CHECK_STATUS);
          }}
        />
        <RadioButton
          style={styles.radioButton}
          ...
          onClick={() => {
            this.handleRadioClick(BOOKING_HELP_OPTIONS.RESEND);
          }}
        />
        <RadioButton
          style={styles.radioButton}
          ...
          onClick={() => {
            this.handleRadioClick(BOOKING_HELP_OPTIONS.CANCEL_BOOKING);
          }}
        />
        <RadioButton
          style={styles.radioButton}
          ...
          onClick={() => {
            this.handleRadioClick(BOOKING_HELP_OPTIONS.MODIFY_BOOKING);
          }}
        />
        <Button
